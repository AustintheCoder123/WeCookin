...
class API:
    ...
    def create_recipe(self, user_preferences, prompt):
        ...
        Unless the user requests for the dish to have certain restrictions, such as being vegetarian or vegan, do NOT create a vegetarian or vegan recipe. Keep it regular unless the user requests.
